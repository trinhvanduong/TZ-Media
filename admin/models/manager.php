...
class TZ_MediaModelManager extends JModelLegacy
{
	...
	function getFolderList($base = null)
	{
		...
		$com_tz_media_base_uni = str_replace(DIRECTORY_SEPARATOR, '/', COM_TZ_MEDIA_BASE);
		...
		$document->setTitle(JText::_('COM_TZ_MEDIA_INSERT_IMAGE'));
		...
		{
			$folder		= str_replace($com_tz_media_base_uni, "", str_replace(DIRECTORY_SEPARATOR, '/', $folder));
	...
	function getFolderTree($base = null)
	{
		...
		$mediaBase = str_replace(DIRECTORY_SEPARATOR, '/', COM_TZ_MEDIA_BASE.'/');
		...
		$tree['data'] = (object) array('name' => JText::_('COM_TZ_MEDIA_MEDIA'), 'relative' => '', 'absolute' => $base);
